...
namespace eval ::optrace {
  variable script "D:/project/verilog/src/15.uart_queue/15.uart_queue.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/project/verilog/src/15.uart_queue/15.uart_queue.runs/synth_1/top.dcp
